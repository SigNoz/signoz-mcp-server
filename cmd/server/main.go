...
func main() {
	...
	// Derive GOMEMLIMIT from the container memory limit before the docs index
	// build so the GC reclaims under pressure instead of the cgroup OOM-killing
	// the pod. No-op when GOMEMLIMIT is already set or no cgroup limit exists.
