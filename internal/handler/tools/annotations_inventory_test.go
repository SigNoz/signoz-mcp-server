...
var expectedToolAnnotations = map[string]annotationTriple{
	...
	"signoz_get_downtime_schedule":       readTriple,
	...
	"signoz_list_downtime_schedules":     readTriple,
	...
	"signoz_create_downtime_schedule":    createTriple,
	...
	"signoz_delete_downtime_schedule":    deleteTriple,
