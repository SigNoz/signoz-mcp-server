...
func (m *MockClient) GetLogPipelines(ctx context.Context, version string) (json.RawMessage, error) {
	if m.GetLogPipelinesFn != nil {
		return m.GetLogPipelinesFn(ctx, version)
	}
	return json.RawMessage(`{}`), nil
}
