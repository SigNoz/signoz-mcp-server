...
type AlertQuerySpec struct {
	...
	Limit        int                  `json:"limit,omitempty" jsonschema:"Positive maximum number of result groups. Use 1000 for scalar and time-series alert builder queries and formulas."`
